...
def seed_users():
    ...
    mike = User(
        username='mike', email='mike@sf.io', password='password', first_name='Michael', last_name='Salariosa', profile_picture='https://pinstorybucket.s3.us-west-1.amazonaws.com/me.png')
